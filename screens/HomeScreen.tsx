...
const HomeScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: isBoy ? '#A1C6F1' : '#FAD6FF' }]}>
      <Animated.View style={{ opacity: fadeAnim, flex: 1, width: '100%', alignItems: 'center' }}>
       ...
       <TouchableOpacity
  style={[styles.button, { backgroundColor: isBoy ? '#4D9DE0' : '#E07A9E' }]}
...
>
  <Text style={styles.buttonText}>Jogo de Leitura</Text>
        ...
        <TouchableOpacity
  style={[styles.button, { backgroundColor: isBoy ? '#6A5ACD' : '#FF7AA2' }]}
...
<TouchableOpacity
  style={[styles.button, { backgroundColor: isBoy ? '#20B2AA' : '#F78DA7' }]}
...
>
  <Text style={styles.buttonText}>Jogo das Vogais</Text>
          ...
          <TouchableOpacity
            style={[styles.button, { backgroundColor: isBoy ? '#FFA07A' : '#F06292' }]}
