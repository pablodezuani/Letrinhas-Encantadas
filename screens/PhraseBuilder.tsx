...
const categories = {
  ...
  Acoes: [
    { word: "Comer", image: require("../assets/words/acao_comer.png") },
    { word: "Beber", image: require("../assets/words/acao_beber.png") },
    { word: "Dormir", image: require("../assets/words/acao_dormir.png") },
    { word: "Brincar", image: require("../assets/words/acao_brincar.png") },
    { word: "Correr", image: require("../assets/words/acao_correr.png") },
    { word: "Pular", image: require("../assets/words/acao_pular.png") },
    { word: "Andar", image: require("../assets/words/acao_andar.png") },
    { word: "Cantar", image: require("../assets/words/acao_cantar.png") },
    { word: "Desenhar", image: require("../assets/words/acao_desenhar.png") },
    { word: "Abraçar", image: require("../assets/words/acao_abracar.png") },
    { word: "Chorar", image: require("../assets/words/acao_chorar.png") },
    { word: "Sorrir", image: require("../assets/words/acao_sorrir.png") },
    { word: "Sentar", image: require("../assets/words/acao_sentar.png") },
    { word: "Levantar", image: require("../assets/words/acao_levantar.png") },
    { word: "Tomar banho", image: require("../assets/words/acao_banho.png") },
  ],
  ...
  Sentimentos: [
    ...
    { word: "Com ciúmes", image: require("../assets/words/com_ciumes.png") },
  ...
  Dores: [
    ...
    { word: "Dor de Dente", image: require("../assets/words/dor_dente.png") },
    { word: "Dor no Braço", image: require("../assets/words/dor_braco.png") },
    { word: "Dor na Perna", image: require("../assets/words/dor_perna.png") },
    { word: "Dor no Pé", image: require("../assets/words/dor_pe.png") },
    { word: "Dor no Ouvido", image: require("../assets/words/dor_ouvido.png") },
    {
      word: "Dor nas Costas",
